...
import Navbar from '@/components/NavBar/NavText/Avatar';
            ...
            <div>
                <header className={`lg:top-8 h-16 lg:h-20 bg-black top-0 w-full flex items-center z-50 fixed ${isNavbarFixed ? 'bg-gray-100' : ''}`}>
                    <div className='w-full lg:px-4'>
                        <div className='lg:grid md:grid md:grid-cols-[3fr,2fr] lg:grid-cols-[3fr,2fr] flex items-center justify-between relative'>
