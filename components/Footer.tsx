...
import Card from './FooterCard';
import Image from 'next/image';
import logoWhite from '@/public/carousel.png';
            ...
            <div className="w-full pt-10 ">
                <div className="flex items-center justify-center mb-5">
                    ...
                    {socialMediaLinks.map((link, index) => (
                        <a key={index} href={link.href} target="_blank" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-100 hover:border-black hover:text-black hover:bg-sky-200">
