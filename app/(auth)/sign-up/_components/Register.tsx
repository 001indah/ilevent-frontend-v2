...
const RegisterValidation = Yup.object().shape({
    ...
    organizer: Yup.boolean().required('Role is required'),
        ...
        onSubmit: async (values) => {
            try {
                await register(
                    ...
                    values.email,
                    values.password,
                    values.organizer ? 'organization' : 'personal',
                    values.phone,
                    values.referralCode
                );
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div>
                                    <label className="inline-flex items-center">
                                        <input
                                            ...
                                            name="organizer"
                                            value="false"
                                            checked={!formik.values.organizer}
                                            onChange={() => formik.setFieldValue('organizer', false)}
                                    ...
                                    <label className="inline-flex items-center ml-6">
                                        <input
                                            ...
                                            value="true"
                                            checked={formik.values.organizer}
                                            onChange={() => formik.setFieldValue('organizer', true)}
                                            className="form-radio"
                                        />
                                ...
                                {formik.touched.organizer && formik.errors.organizer && (
                                    <small className="text-red-500">{formik.errors.organizer}</small>
                                )}
