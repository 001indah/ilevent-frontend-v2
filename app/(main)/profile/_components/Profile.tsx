...
// // ... (interface Ticket dan UserProfile tetap sama)

// // OrderCard component tetap sama
...
//     const [tickets, setTickets] = useState<Ticket[]>([]); // Tambahkan state untuk tiket

//     useEffect(() => {
//         const checkAuth = async () => {
//             // Changed: Check for token in localStorage instead of using isAuthenticated
...
//             // Tambahkan notifikasi sukses di sini jika diperlukan
//             setIsEditDialogOpen(false);
//             await fetchProfileData();
//         } catch (error) {
//             console.error('Error updating profile:', error);
//             // Tambahkan notifikasi error di sini jika diperlukan
//         }
//     };
